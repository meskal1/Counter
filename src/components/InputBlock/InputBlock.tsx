...
export const InputBlock: React.FC<InputBlockType> = ({ type, inputID, maxNumber, startNumber, labelValue, inputValue, onChangeInputHandler, onFocusInputHandler, onBlurInputHandler, onKeyPressInputHandler, isDisabledSettingsButton }) => {
	...
	const onChangeInput = (e: ChangeEvent<HTMLInputElement>) => {
		onChangeInputHandler(inputID, +e.currentTarget.value)
	};

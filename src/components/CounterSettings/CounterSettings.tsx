...
export const CounterSettings: React.FC<CounterSettingsType> = ({
  ...
  const onChangeInputHandler = (inputID: string, inputValue: number) => onChangeInput(inputID, inputValue)
  const onClickButtonSet = () => onClickSetButton()
  const onFocusInputHandler = () => onFocusInput()
  const onBlurInputHendler = () => onBlurInput()
  const onKeyPressInputHandler = () => onKeyPressInput()
